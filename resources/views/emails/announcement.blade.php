          ...
          <tr>
            <td style="background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 24px rgba(46, 49, 146, 0.08); overflow: hidden;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                {{-- Header --}}
                <tr>
                  <td style="background: linear-gradient(135deg, #7c3aed 0%, #4c1d95 100%); padding: 28px 32px; border-radius: 16px 16px 0 0;">
                ...
                {{-- Body --}}
                <tr>
                  <td align="{{ app()->getLocale() === 'ar' ? 'right' : 'left' }}" style="padding: 8px 32px 32px 32px; font-size: 16px; color: #334155; line-height: 1.7;">
                    {!! nl2br(e($emailBody)) !!}
                  </td>
                </tr>
                      ...
                      <tr>
                        <td align="center" style="background-color: #2e3192; border-radius: 12px;">
                          <a href="{{ config('app.url') }}" target="_blank" style="display: inline-block; padding: 14px 40px; font-size: 16px; font-weight: 700; color: #ffffff; text-decoration: none; border-radius: 12px; background-color: #2e3192; font-family: 'Readex Pro', 'Segoe UI', Tahoma, Arial, sans-serif;">
                            {{ app()->getLocale() === 'ar' ? 'زيارة المنصة' : 'Visit Platform' }}
                          </a>
                        </td>
                      </tr>
                    </table>
                ...
                {{-- Footer note --}}
                <tr>
                  <td align="{{ app()->getLocale() === 'ar' ? 'right' : 'left' }}" style="padding: 0 32px 32px 32px; font-size: 13px; color: #94a3b8; line-height: 1.6; border-top: 1px solid #e2e8f0;">
                    <br>
                    {{ app()->getLocale() === 'ar'
                      ? 'تلقيت هذا البريد لأنك مسجل في منصة ERADC.'
                      : 'You received this email because you are a registered member of ERADC.' }}
                  </td>
                </tr>
