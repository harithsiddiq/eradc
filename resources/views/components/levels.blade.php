...
<section id="levels" class="py-12 hidden sm:py-16 bg-slate-0">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-right max-w-6xl ml-auto">
      <h3 class="text-2xl sm:text-3xl font-extrabold tracking-tight text-primary-blue mb-6">{{ __('levels.title') }}
      </h3>
          ...
          <details>
            <summary>
              <div class="flex items-center gap-3 justify-end">
                <span class="title">{{ __('levels.day_intro') }}</span>
              </div>
            ...
            <div class="content">
              <p class="mt-3 space-y-2">{{ __('levels.description') }}</p>
              <a href="#" class="action-btn"><span>{{ __('learn_more') }}</span><i class="fi fi-rr-arrow-left"
