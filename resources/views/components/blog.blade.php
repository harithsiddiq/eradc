              ...
              @foreach ($posts as $post)
                <div class="swiper-slide" style="height: 280px;">
                  <div class="relative"
                    ...
                    <div
                      style="position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(46,49,146,0.70) 0%, rgba(46,49,146,0.50) 40%, rgba(0,0,0,0.00) 100%);">
                    </div>
                    <div
                      style="position: absolute; left: 0; right: 0; bottom: 0; display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 16px;">
