...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <title>EradcHub — Landing</title>
    <meta name="description" content="EradcHub landing page." />
  ...
  <body class="bg-white text-neutral-dark antialiased overflow-x-hidden min-h-screen">
    ...
    <script>
      ...
      var infraSwiper = document.querySelector('.infraSwiper');
      if (infraSwiper) {
        new Swiper('.infraSwiper', {
          slidesPerView: 1,
          spaceBetween: 30,
          pagination: { el: '.infra-swiper-pagination', clickable: true },
          breakpoints: { 640: { slidesPerView: 2, spaceBetween: 24 }, 1024: { slidesPerView: 3, spaceBetween: 24 } }
        });
      }
